...
class OsmSyncRun(Base):
    ...
    status: Mapped[str] = mapped_column(String(20), default="running", server_default="running")  # running | success | failed
    server: Mapped[str | None] = mapped_column(String(200), nullable=True)
    elements: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    ...
    deactivated: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
